...
| Protein | amino-acid sequences, text descriptions, functional annotations, Foldseek 3Di protein-structure tokens | Scientific QA: Function, General function; property prediction: fluorescence, stability, structural similarity, TM-score; classification/annotation: solubility, antibody-antigen interaction, yeast/human PPI, protein function, domain motif, fold type, subcellular localization, EC number, keywords, metal ion binding, GO-BP, GO-CC, GO-MF; generation/design: function-guided protein design, catalytic activity. |
